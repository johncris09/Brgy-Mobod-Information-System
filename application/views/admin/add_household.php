							...
							<div class="col-md-12 ">
								<div class="card card-cascade narrower">
									...
									<div class="card-body card-body-cascade">
										<form id="add_household_form" method="post">
													...
													<?Php
														if($purok->num_rows() > 0):
															foreach($purok->result_array() as $row):
																echo ' 
																	<option value="'.$row['purok_id'].'">'.ucfirst($row['purok']).'</option> 
																';
															endforeach;
														endif; 
													?>
											...
											<div class="form-group">
												<label for="household_no" class="control-label mb-1">Household # <sup class="text-danger">*</sup></label>
												<input name="household_no" id="household_no" type="text" class="form-control"
													placeholder="Household #" required autofocus>
											</div> 
											<div>
