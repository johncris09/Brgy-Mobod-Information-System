							...
							<div class="col-md-12 ">
								<div class="card card-cascade narrower">
									...
									<div class="card-body card-body-cascade">
										<hr>
										<form id="add_position_form" method="post">
											<div class="form-group">
												<label for="position" class="control-label mb-1">Position</label>
												<input name="position" id="position" type="text" class="form-control" placeholder="Position" required autofocus>
											</div>
											<div>
												<button title="Add Position" type="submit"
													class="btn blue-gradient btn-block btn-rounded z-depth-1a">Add Position</button>
											</div>
										</form>
									</div>
								</div>
