									...
									<div class="card-body card-body-cascade">
										...
										<form id="add_user_type_form" method="post">
											<div class="form-group">
												...
												<input name="user_type" id="user_type" type="text" class="form-control" placeholder="User Type" required autofocus>
											</div>
											<div>
												<button title="Add User Type" type="submit"
													class="btn blue-gradient btn-block btn-rounded z-depth-1a">Add User Type</button>
											</div>
										</form>
									</div>
								</div>
