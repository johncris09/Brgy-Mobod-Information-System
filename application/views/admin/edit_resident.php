								...
								<div class="card card-cascade narrower">
									...
									<div class="card-body card-body-cascade">
										...
										<div class="row">
											...
											<div class="col-md-12">
												<form id="update_resident_form" method="post">
													<label class="h4">Personal Informaton</label>
													<hr> 
													<input value="<?php echo $resident['resident_id']; ?>" name="resident_id" id="resident_id" type="hidden" class="form-control">
													<div class="form-group">
														<label for="last_name" class="control-label mb-1">Last Name <sup class="text-danger">*</sup></label>
														<input value="<?php echo $resident['last_name']; ?>" name="last_name" id="last_name" type="text" class="form-control"
															placeholder="Last Name" required autofocus>
													</div>
													<div class="form-group">
														<label for="first_name" class="control-label mb-1">First Name <sup class="text-danger">*</sup></label>
														<input value="<?php echo $resident['first_name']; ?>" name="first_name" id="first_name" type="text" class="form-control"
															placeholder="First Name" required>
													</div>
													<div class="form-group">
														<label for="middle_name" class="control-label mb-1">Middle Name</label>
														<input value="<?php echo $resident['middle_name']; ?>" name="middle_name" id="middle_name" type="text" class="form-control"
															placeholder="Middle Name">
													</div>
													<div class="form-group">
														<label for="extension" class="control-label mb-1">Extension</label>
														<input value="<?php echo $resident['extension']; ?>"  name="extension" id="extension" type="text" class="form-control"
													...
													<div class="form-group">
														...
														<textarea   name="birthplace" id="birthplace" class="form-control"
															placeholder="Birthplace" required><?php echo $resident['birthplace']; ?></textarea>
													</div>
													<div class="form-group">
														<label for="birthdate" class="control-label mb-1">Birthdate <sup class="text-danger">*</sup></label>
														<input value="<?php echo $resident['birthdate']; ?>" name="birthdate" id="birthdate" type="date" class="form-control"
															...
															<?php
																if($household->num_rows() > 0):
																	foreach($household->result_array() as $row):
																		$selected = ""; 
																		if($resident['household_id'] == $row['household_id']):
																			$selected = "selected"; 
																		endif; 
																		echo ' 
													...
													<div>
														<button title="Update Resident" type="submit"
															class="btn blue-gradient btn-block btn-rounded z-depth-1a">Update Resident</button>
													</div>
												</form>
											</div>
										</div>
