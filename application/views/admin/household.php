							...
							<div class="col-md-12 ">
								<div class="card card-cascade narrower">
									<div class="view view-cascade gradient-card-header purple-gradient">
										...
										<a href="<?php echo base_url() . 'household/print' ?>"
											class="float-right text-white btn-rounded  btn-lg aqua-gradient my-2 mx-2  " title="Print">
											<i class="fas fa-print"></i>
										</a>
										<a href="<?php echo base_url() . 'household/add_household' ?>"
											class="float-right text-white btn-rounded  btn-lg peach-gradient my-2 mx-2  " title="Add Household">
