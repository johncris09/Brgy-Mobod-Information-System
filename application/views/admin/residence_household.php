							...
							<div class="col-md-12 ">
								<div class="card card-cascade narrower">
									<div class="view view-cascade gradient-card-header purple-gradient">
										...
										<a href="<?php echo base_url() . 'resident/print' ?>"
											class="float-right text-white btn-rounded  btn-lg aqua-gradient my-2 mx-2  " title="Print">
											<i class="fas fa-print"></i>
										</a> 
										<a href="<?php echo base_url() . 'resident/add_resident?household_id='.$this->uri->segment(3) ?>"
											class="float-right text-white btn-rounded  btn-lg peach-gradient my-2 mx-2  "
											title="Add resident">
											<i class="fas fa-plus"></i> Add resident
										</a>
									</div>
									<div class="card-body card-body-cascade text-center"> 
										<span class="text-hide" id="household_id"><?php echo $this->uri->segment(3); ?></span>
										<div id="residence_household_list"></div>
									</div>
								</div>
							</div>
						</div>
