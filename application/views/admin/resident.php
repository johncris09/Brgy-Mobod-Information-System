							...
							<div class="col-md-12 ">
								<div class="card card-cascade narrower">
									<div class="view view-cascade gradient-card-header purple-gradient">
										...
										<a href="<?php echo base_url() . 'resident/add_resident' ?>"
											class="float-right text-white btn-rounded  btn-lg peach-gradient my-2 mx-2  " title="Add resident">
											<i class="fas fa-plus"></i> Add resident
										</a>
									</div>
									<div class="card-body card-body-cascade text-center">
										<div id="resident_list"></div>
									</div>
								</div>
							</div>
						</div>
