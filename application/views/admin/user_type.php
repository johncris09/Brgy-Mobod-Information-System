							...
							<div class="col-md-12 ">
								<div class="card card-cascade narrower">
									<div class="view view-cascade gradient-card-header purple-gradient">
										...
										<a href="<?php echo base_url() . 'user_type/add_user_type' ?>"
											class="float-right text-white btn-rounded  btn-lg peach-gradient my-2 mx-2  " title="Add User Type">
											<i class="fas fa-plus"></i> Add User Type
										</a>
									</div>
									<div class="card-body card-body-cascade text-center">
										<div id="user_type_list"></div>
									</div>
								</div>
							</div>
						</div>
