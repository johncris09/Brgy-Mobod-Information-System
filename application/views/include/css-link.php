	...
	<!-- Vendor CSS--> 
	<link href="<?php echo base_url() ?>assets/vendor/MDB-Free_4.8.11/css/mdb.css" rel="stylesheet" media="all">
	...
	<link href="<?php echo base_url() ?>assets/vendor/jquery-confirm/css/jquery-confirm.css" rel="stylesheet" media="all">
	<!-- Main CSS-->
